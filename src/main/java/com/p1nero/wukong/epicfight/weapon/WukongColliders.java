...
public class WukongColliders {
    public static final Collider WK_STAFF = new MultiOBBCollider(4, 0.2, 0.2, 1.6, 0.0, 0.0, 0.0);
    public static final Collider POKE_0 = new MultiOBBCollider(4, 0.3, 0.3, 1.6, 0.0, 0.0, -0.4);
